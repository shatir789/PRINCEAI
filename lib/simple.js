...
let canalId = ["120363199257221654@newsletter", "120363422421446303@newsletter", "120363199257221654@newsletter", "120363419257382324@newsletter", "120363422421446303@newsletter"]
let canalNombre = ["Prince🍁", "🕋♥️✨ ~ The Community of Believers ~ ✨♥️🕋", "🍁Prince Support🍁", "🪄Global Updates🪄", "🌹دینِ اسلام🌹"]
...
export function smsg(conn, m, hasParent) {
    ...
    if (!m.mediaMessage) delete m.download
     ...
     if (m.msg?.contextInfo?.mentionedJid?.length) {
      ...
      // Here you do the redefinition only if it doesn't already exist:
